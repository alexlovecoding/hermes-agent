...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("mode", "Show or set session working mode", "Session",
               args_hint="[status|research|maintainer|planning|clear]",
               subcommands=("status", "research", "maintainer", "planning", "clear")),
